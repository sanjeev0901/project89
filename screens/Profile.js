...
import { StyleSheet, Text, View,Switch,Platform,Image,SafeAreaView,StatusBar } from "react-native";
...
export default class Profile extends Component {
  ...
  render() {
    if (!this.state.fontsLoaded) {
      ...
      return (
        <View style={this.state.light_theme?styles.container:styles.containerDark}>
